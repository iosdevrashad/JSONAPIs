...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "iosdevrashad" => "rashad8787@me.com" }
  # Or just: spec.author    = "iosdevrashad"
  # spec.authors            = { "iosdevrashad" => "rashad8787@me.com" }
  # spec.social_media_url   = "https://twitter.com/iosdevrashad"
